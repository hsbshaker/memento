      ...
      <MobilePageContainer className="pb-20">
        <div className="mx-auto max-w-xl pt-8">
          <Surface className="border-destructive/30 bg-destructive-muted p-6 sm:p-7">
            <p className="text-sm font-medium tracking-[0.22em] text-destructive uppercase">Settings</p>
            <h1 className="mt-3 text-2xl font-semibold tracking-tight text-foreground">We couldn’t load your settings right now.</h1>
