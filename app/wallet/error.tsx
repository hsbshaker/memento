      ...
      <MobilePageContainer className="pb-20">
        <div className="mx-auto max-w-xl pt-8">
          <Surface className="rounded-3xl border-rose-300/20 bg-rose-300/10 p-6 sm:p-7">
            <p className="text-sm font-medium tracking-[0.22em] text-rose-100/80 uppercase">Wallet</p>
            <h1 className="mt-3 text-2xl font-semibold tracking-tight text-white">We couldn’t load your cards right now.</h1>
