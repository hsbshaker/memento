...
export function HomeAllCaughtUpState({
  ...
  return (
    <section
      className={
        compact
          ? "rounded-[1rem] border border-white/[0.05] bg-white/[0.015] px-4 py-4"
          : "rounded-[1.6rem] border border-emerald-300/12 bg-[#101817]/96 px-4 py-4 shadow-[0_18px_40px_-34px_rgba(0,0,0,0.92)] sm:px-5 sm:py-5"
      }
    >
