  ...
  return (
    <div className="py-12">
      <div className="max-w-md">
        <h2 className="text-2xl font-semibold tracking-tight text-foreground">No cards yet</h2>
        <p className="mt-2 text-sm text-muted-foreground">Add your first card to build your wallet.</p>
        <div className="mt-5">
